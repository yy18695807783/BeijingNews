...
import com.atguigu.beijingnews.alipay.PayResult;
import com.atguigu.beijingnews.alipay.SignUtils;
...
//        }
        if (shoppingCarts != null && shoppingCarts.size() > 0) {
            ...
            ShoppingCartAdapter cartAdapter = new ShoppingCartAdapter(context,shoppingCarts, tv_price_all, cb_all);
...
//    /**
//     * 检验是否有商品  没有显示没有商品信息
//     * 开始没有adapter 所以盘空时空指针  在设置adapter中设置tv_resoult的是否显示  变通
//     */
//    private void checkData() {
//        if (adapter != null & adapter.getItemCount() > 0) {//开始没有adapter 所以盘空时空指针  在设置adapter中设置tv_resoult的是否显示
//            //购物车有商品
//            tv_resoult.setVisibility(View.GONE);
//        } else {
//            //购物车没有商品
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_buy://去结算按钮
                //支付
//                Toast.makeText(context, "马上支付", Toast.LENGTH_SHORT).show();
                double resultPrice = adapter.getTotalPrice();//传入商品价格  商品信息也可以传入
                pay(v,resultPrice);
                break;
...
//                tv_resoult.setVisibility(View.VISIBLE);
     ...
     *
     */
    public void pay(View v, double resultPrice) {
...
//                            finish();
        ...
        String orderInfo = getOrderInfo("测试的商品", "该测试商品的详细描述", resultPrice + "");
