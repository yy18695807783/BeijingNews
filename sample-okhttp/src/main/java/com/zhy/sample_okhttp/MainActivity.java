...
//        url =3.125.219.144:8443/mobileConnect/MobileConnect/authLogin.action?systemid=100009&mobile=13260284063&pipe=2&reqtime=1422986580048&ispin=2";
    ...
    public void uploadFile(View view)
    {
        ...
        File file = new File(Environment.getExternalStorageDirectory(), "yy.jpg");
        if (!file.exists())
        {
            Toast.makeText(MainActivity.this, "文件不存在，请修改文件路径", Toast.LENGTH_SHORT).show();
            return;
        ...
        String url = "http://192.168.12.54:8080/FileUpload/FileUploadServlet";

        OkHttpUtils.post()//
                .addFile("mFile", "yanyin_01", file)//
                .url(url)//
                .params(params)//
                .headers(headers)//
                .build()//
    ...
    {
        File file = new File(Environment.getExternalStorageDirectory(), "yy.jpg");
        File file2 = new File(Environment.getExternalStorageDirectory(), "yy2.txt");
        if (!file.exists())
        {
            Toast.makeText(MainActivity.this, "文件不存在，请修改文件路径", Toast.LENGTH_SHORT).show();
            return;
        ...
        String url =  "http://192.168.12.76:8080/FileUpload/FileUploadServlet";
        OkHttpUtils.post()//
                .addFile("mFile", "yanyin_01.jpg", file)//
                .addFile("mFile", "yy2.txt", file2)//
                .url(url)
                .params(params)//
                .build()//
                .execute(new MyStringCallback());
    ...
    {
        String url = "http://192.168.12.76:8080/web_home/oppo.mp4";
        OkHttpUtils//
                .get()//
                .url(url)//
                .build()//
